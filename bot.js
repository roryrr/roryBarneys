...
app.post('/ai', (req, res) => {
  ...
  if (req.body.result.action === 'weather') {
    ...
    var apiKey= process.env.API_KEY,
          ...
          sessionId= process.env.SESSION_ID,
          placements= process.env.PLACEMENTS_ID_FIND;
        var  requesting = req_url + "?apiKey=" + apiKey + "&apiClientKey=" + apiClientKey + "&userId=" + userId + "&sessionId=" + sessionId + "&placements=" + placements + "&lang=en&facet=&start=0&rows=5&query=" + findProductName + "&filter=" + findBrand + "&filter=" + findGender + "&color=" + findcolor;
