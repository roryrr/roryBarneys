    ...
    app.post('/ai', (req, res) => {
      ...
      if (req.body.result.action === 'weather') {
        ...
        if (req.body.result.contexts[0].parameters['brand']) {
          ...
          GLOBAL_PRODUCT_BRAND?(GLOBAL_PRODUCT_BRAND='brand:\"'+GLOBAL_PRODUCT_BRAND+'\"'):(GLOBAL_PRODUCT_BRAND=GLOBAL_PRODUCT_BRAND);
        }
        if (req.body.result.contexts[0].parameters['user-size']) {
          ...
          GLOBAL_PRODUCT_SIZE?(GLOBAL_PRODUCT_SIZE='size:\"'+GLOBAL_PRODUCT_SIZE+'\"'):(GLOBAL_PRODUCT_SIZE=GLOBAL_PRODUCT_SIZE);
        }
